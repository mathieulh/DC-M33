...
DC8/msipl.bin:
	...
	python3 psptools/pack_ipl.py ipl/msipl/msipl.bin@0x40c0000 DC8/msipl.bin 0x40c0000
...
DC8/nandipl_01g.bin:
	...
	python3 psptools/pack_ipl.py ipl/ipl_stage1_payload/ipl_stage1_payload.bin@0x40e0000 500/ipl_01g.bin@0x40f0000 DC8/nandipl_01g.bin 0x40e0000
...
DC8/nandipl_02g.bin:
	...
	python3 psptools/pack_ipl.py ipl/ipl_stage1_payload/ipl_stage1_payload.bin@0x40e0000 500/ipl_02g.bin@0x40f0000 DC8/nandipl_02g.bin 0x40e0000
	...
	python3 psptools/pack_ipl.py ipl/ipl_stage1_payload/ipl_stage1_payload.bin@0x40e0000 500/ipl_03g.bin@0x40f0000 DC8/nandipl_03g.bin 0x40e0000
